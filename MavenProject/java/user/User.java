...
public class User {
	...
	{
		FileInputStream file=new FileInputStream("C:\\Users\\SREEKUTTY K V\\git\\Java\\SampleMaven\\src\\main\\resources\\Bank.xlsx");
	...
	public void readFederal()
	{
		...
		Cell c1=sheet.getRow(3).getCell(1);
		Cell c2=sheet.getRow(3).getCell(2);
		Cell c3=sheet.getRow(3).getCell(3);
